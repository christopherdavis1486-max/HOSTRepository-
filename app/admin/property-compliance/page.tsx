...
export default function AdminPropertyCompliancePage(){
  ...
  return <main style={{minHeight:"100vh",background:"#100f0c",color:"#fff8e8",padding:"48px 6vw",fontFamily:"Arial,sans-serif"}}><div style={{maxWidth:1100,margin:"0 auto"}}>
    <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}><a href="/admin/security" style={{color:"#c4a98b"}}>← {ht("Admin security")}</a><a href="/admin/listing-readiness" style={{color:"#d49a3f"}}>{ht("Pilot listing review")}</a><LanguageSelector compact/></div>
