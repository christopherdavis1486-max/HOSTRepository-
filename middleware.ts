...
function addSecurityHeaders(response: NextResponse) {
  ...
  response.headers.set("Content-Security-Policy", [
    ...
    "img-src 'self' data: blob: https://*.blob.vercel-storage.com https://*.tile.openstreetmap.org", "connect-src 'self' https://api.stripe.com https://*.stripe.com https://vercel.com https://*.blob.vercel-storage.com",
